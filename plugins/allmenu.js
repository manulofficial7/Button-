...
let tags = {}
const defaultMenu = {
  before: `හායි Bro/Sister %name 🍁.
මම යමක් කිරීමට, සෙවීමට, හෝ දත්ත/තොරතුරු ලබා ගැනීමට ඔබට උදවු කරන ස්වයංක්‍රීය පද්ධතියකි. (WhatsApp Bot) එහෙත් whatsapp වේ. 
...
. .╰─── ︶︶︶︶ ♡⃕  ⌇. . .
 ...
 . . ┊⿻ [ *ᴄʀᴇᴀᴛᴏʀ* :: ©Manul Official ]. . 
 . . ╰─────────╮

ඔබ කිසියම් දෝෂයක් සොයා ගන්නේ නම් හෝ ඔබේ වාරික සැලැස්ම උත්ශ්‍රේණි කිරීමට කැමති නම්, කරුණාකර හිමිකරු සම්බන්ධ කරගන්න.
%readmore
`.trimStart(),
  header: '─₍🍁₎❝┊ *%category*',
 ...
 type: 'audioMessage',  
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'ᴇʟᴀɪɴᴀ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', body: wm, sourceUrl: 'https://whatsapp.com/channel/0029VaN1XMn2ZjCsu9eZQP3R', thumbnail: await (await fetch(bjir)).buffer(),}}  
  }) 
    } catch (e) {
