...
seconds: 22,
fileLength: 22,
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'ᴍʏ ᴄʀᴇᴀᴛᴏʀ ᴇʟᴀɪɴᴀ-ᴀɪ', body: wm, sourceUrl: 'https://wa.me/62895401357755?text=Assalamualaikum', thumbnail: await (await fetch(bjir)).buffer(),}} 
 })
