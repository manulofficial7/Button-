...
await conn.sendMessage(m.chat, {text: loadd[i], edit: key })}
    let { anon, anticall, antispam, antitroli, backup, jadibot, groupOnly, statusupdate, autogetmsg, antivirus, publicjoin } = global.db.data.settings[conn.user.jid]
...
┌ ◦ *කාලය තුළ ක්රියාකාරීන්වය* ${uptime}
│ ◦ *${groups.length}* සමූහ
...
seconds: 18,
fileLength: 18,
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'ᴇʟᴀɪɴᴀ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', body: wm, sourceUrl: 'https://whatsapp.com/channel/0029VaN1XMn2ZjCsu9eZQP3R', thumbnail: await (await fetch(thumb)).buffer(),}}  
  }) 
}
